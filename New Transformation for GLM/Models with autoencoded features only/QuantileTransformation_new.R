QuantileTransformation_new <- function(train_vec, test_vec) {
  ...
  train_transformed[valid_train_idx] <- train_ranks
  ...
  test_transformed[valid_test_idx] <- test_probs
  
  return(list(train = train_transformed,
