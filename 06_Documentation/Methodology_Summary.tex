...
Based on the instructions from the client, we filter the balance sheet data based on the following constraints to remove noisy observations. To account for floating-point inconsistencies, we allow for a rounding error of 2 decimal places.
...
\toprule
\textbf{Task} & \textbf{Tristan} & \textbf{Nastia} & \textbf{Leonid} & \textbf{Martin} \\
\midrule
Data Preprocessing                   & \textbf{X} & \textbf{X} &            &            \\
Feature Engineering (Standardization \& PIT)     
                                     & \textbf{X} &            &            &            \\
Stratified Sampling within Train Set &            &            &            & \textbf{X} \\
GLMs and regularized GLMs            &            &            &            &            \\
Random Forest and Boosting           & \textbf{X} & \textbf{X} &            &            \\
Neural Networks                      &            &            &            &            \\
\bottomrule
\end{tabular}
\end{table}
