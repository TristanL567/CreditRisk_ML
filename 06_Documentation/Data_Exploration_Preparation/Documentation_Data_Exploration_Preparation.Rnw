...
Path <- "C:/Users/TristanLeiter/Documents/Privat/ILAB/CreditRisk_ML/06_Documentation/Data_Exploration_Preparation"
Directory <- file.path(Path, "Documentation_Data_Exploration_Preparation.Rnw")
# Directory_Tex <- file.path(Path, "Data_Exploration_Preparation.tex")
setwd(Path)

##
Path_General <- "C:/Users/TristanLeiter/Documents/Privat/ILAB/CreditRisk_ML"
Charts_Directory <- file.path(Path_General, "03_Charts")
...
<<default_sector_plot, echo=FALSE, fig.cap="Defaulting Firms", out.width='\\linewidth'>>=
...
%==== Chapter 1c: Feature Engineering =========================================%
...
<<mc_plot, echo=FALSE, fig.cap="Multicollinearity", out.width='\\linewidth'>>=
...
<<iv_plot, echo=FALSE, fig.cap="IV per feature", out.width='\\linewidth'>>=
