...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `file.path()`:\\\#\# ! object 'Directory' not found}}\end{kframe}
\end{knitrout}

\begin{kframe}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `xtable()`:\\\#\# ! object 'glm\_results\_table' not found}}\end{kframe}
